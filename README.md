...
| 8 | `8-accounting/` | QuickBooks Online MCP server (vendored fork of [@qboapi/qbo-mcp-server](https://www.npmjs.com/package/@qboapi/qbo-mcp-server)) — 144 tools across 29 QBO entities for invoices, customers, P&L, etc. | 20 min |
